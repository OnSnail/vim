...
vim -c "set tags=~/yottabyte/src/rizhiyi_manager_agent/tags" \
  ...
  -c "nnoremap <silent> <F5>  :<C-u>Unite -smartcase -buffer-name=files -start-insert file_rec/git:/Users/wrb/yottabyte/src/rizhiyi_manager_agent/:--full-name<CR>" \
  -c "nnoremap <F3>  :<C-u>Unite -smartcase -start-insert grep:/Users/wrb/yottabyte/src/rizhiyi_manager_agent/:--python<CR>" \
