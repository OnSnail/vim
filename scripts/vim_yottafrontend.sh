...
vim --cmd "set tags=~/yottafrontend/tags" \
  ...
  -c "nnoremap <silent> <F5>  :<C-u>Unite -smartcase -buffer-name=files -start-insert file_rec/git:/Users/wrb/yottabyte/src/yotta_elasticsearch/frontend_refactor/:--full-name<CR>" \
  -c "nnoremap <F3>  :<C-u>Unite -smartcase -start-insert grep:/Users/wrb/yottabyte/src/yotta_elasticsearch/frontend_refactor/:--scala<CR>" \
